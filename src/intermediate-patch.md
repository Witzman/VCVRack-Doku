...
Add **Bogaudio VCO** (search "Bogaudio VCO" in the browser). This is a more flexible oscillator than VCV Free's VCO.
...
- Take the SIN output through a **VCV Free 8vert** channel (attenuate to about 0.4).
